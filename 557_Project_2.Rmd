...
#score_data %>% 
#  ggplot(aes(glm.link.scores=link, y=response, col=class)) + 
...
plot(roc(seismic.test$class, glm.response.scores, direction="<"),
     col="yellow", lwd=3, main="The turtle finds its way")

roc(seismic.test$class, glm.response.scores, direction="<")
